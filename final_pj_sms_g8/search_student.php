    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li><a href="dashboard.php"><i class="fas fa-th-large"></i> Class Management</a></li>
                <li><a href="search_student.php" class="active"><i class="fas fa-search"></i> Search Students</a></li>
            </ul>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?php if ($user_role == 'admin'): ?>
                                    <a href="edit-student.php?id=<?php echo $row['id']; ?>" class="btn btn-edit">Edit</a>
